...
tldr:
  ...
  summary:
    - "Poko allows Pokemon Go players to find and communicate with other trainers nearby. When Pokemon Go first launched it was a huge hit, but was lacking any kind social features. Trainers wanted a way to interact with others so they could coordinate battles and share resources and information. Poko aimed to fill this gap by providing a simple chat interface for Pokemon Trainers."
  skills:
...
galleries:
    - id: 'branding'
      images:
        - 'images/work/branding-01.jpg'
        - 'images/work/branding-02.png'
    - id: 'nearbyMock'
      images:
...
<ContentGallery fullWidth gallery={props.galleries.branding} />
...
<CaseSection
  title="Sign Up Flow"
  stepNum="03"
  intro="We kept the sign up flow simple, so that users could get up and running quickly. Users choose a sign up method, enter their username, and declare their team. We limited sign-up to only google and facebook initially. This allowed us to find your friends and provided a bit of shielding from spam bots and bad-actors.">
...
<CaseSection
  sticky
  title="But, did you learn anything?"
  stepNum="04"
