...
tldr:
  ...
  summary:
    ...
    - "By bringing new design and testing strategies to TIDAL, the team was able to be more productive with our limited resources, be more creative, and test more efficiently. This helped us increase click through rates 30%, lower cost per acquisition 50%, and increase sign-up completion 20%."
  skills:
...
First, met with executive stakeholders so I could understand their expectations for the Growth team’s KPIs and Goals. Then I met with the Growth creative team, individually and as a group, to gather their ideas, and better understand where their pain points were so we could build a better process.
...
The entire team (not just creatives) collects inspiration from competitors and beyond. The inspiration wasn’t just limited to ad creative, but whatever you could find. We would meet to go over our inspiration and take turns talking about what we liked or didn’t like about it, and what learnings we could take away to apply in our own testing. 
...
At the core of all our testing are Concepts. These are ideas we can turn into ad creative and eventually iterate on. Taking the research and inspiration from the day before, the team would ideate and submit concepts. At the end of the day we would meet, and in a pitch-style meeting everyone walks the team through their concepts. Sometimes we would form teams to help with ideation. The team then votes on which concept to explore that week.
...
The creative team meets to review the concept and produce a creative brief to help further explore and define the concept. The team then breaks off to start exploring possible creative executions.
...
You can check out an early version of the Airtable here
...
<CaseSection
  ...
  stepNum="03"
  intro="We continuously tested our marketing creative and concepts, producing thousands of assets, to find what resonated with our various audiences and inform our branding strategy.">
...
<CaseSection
  ...
  stepNum="03"
  intro="We ran A/B tests on landing pages testing different copy, imagery, and layouts. Ultimately landing on a simple, modern look somewhere between tech and luxury brands.">
...
<CaseSection
  title="Sign Up Flow"
  stepNum="03"
  intro="After collecting feedback from real users, we found common friction points and hypothesized solutions. We explored, wireframed, and designed solutions, then worked with the Development team to scope and implement A/B tests on the sign up flow.">
