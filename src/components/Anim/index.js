...
export const scrollHintAnim = (trigger) => {
  const hint = trigger.lastChild

  const loop = gsap.timeline({repeat: -1, yoyo: true})

  loop.to(hint, {autoAlpha: .5, duration: 1, ease: 'power2.inOut'})
...
//Case Study Section Intro Fade Up
